 ...
 */
const ChangePasswordView: React.FC<ChangePasswordViewProps> = ({ handleProfile }) => {
    const {
        currentPassword,
        setCurrentPassword,
        newPassword,
            ...
            <Paper elevation={3} className="change-password-paper">
                ...
                <form className="change-password-form">
                    ...
                    <TextField
                        ...
                        helperText={newPasswordError || "Must be at least 8 characters with uppercase, lowercase, and number"}
                        required
                        disabled={loading || !!success}
                    />
